...
<body class="flex-center-row" id="capture">
<div class="center_box">
    <form action="EvaluateTeam.do" method="post" name="evalteam">
        <div class="title_box">
            <span class="_title">졸업작품 심사서 결과서</span>
        </div>
            ...
            <div class="check_box">
                <div class="question_box">
                    ...
                    <ul class="btn_box flex-space-row">
                        <li class="radio_txt"><input checked type="radio" name="val_1" value="10">아주우수</li>
                        <li class="radio_txt"><input type="radio" name="val_1" value="8">우수</li>
                        <li class="radio_txt"><input type="radio" name="val_1" value="6">보통</li>
                        <li class="radio_txt"><input type="radio" name="val_1" value="4">불량</li>
                        <li class="radio_txt"><input type="radio" name="val_1" value="2">매우불량</li>
                    </ul>
                ...
                <div class="question_box">
                    ...
                    <ul class="btn_box flex-space-row">
                        <li class="radio_txt"><input checked type="radio" name="val_2" value="10"<c:if test = "${ '10' eq v2}">checked</c:if>>아주우수</li>
                ...
                <div class="question_box">
                    ...
                    <ul class="btn_box flex-space-row">
                        <li class="radio_txt"><input checked type="radio" name="val_3" value="10"<c:if test = "${ '10' eq v3}">checked</c:if>>아주우수</li>
...
<div class="center_box">
    ...
    <div class="question_box">
        ...
        <ul class="btn_box flex-space-row">
            <li class="radio_txt"><input checked type="radio" name="val_5" value="10"<c:if test = "${ '10' eq v5}">checked</c:if>>아주우수</li>
    ...
    <div class="question_box">
        ...
        <ul class="btn_box flex-space-row">
            <li class="radio_txt"><input checked type="radio" name="val_6" value="10"<c:if test = "${ '10' eq v6}">checked</c:if>>아주우수</li>
    ...
    <div class="question_box">
        ...
        <ul class="btn_box flex-space-row">
            <li class="radio_txt"><input checked type="radio" name="val_7" value="10"<c:if test = "${ '10' eq v7}">checked</c:if>>아주우수</li>
    ...
    <div class="result_box">
        <div class="lastEval_box flex-center-row">
...
<!-- <script src="src/bluebird.min.js"></script> -->
